CREATE DATABASE IF NOT EXISTS media_crawler CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE media_crawler;
-- ----------------------------
...
(
    ...
    `date`             VARCHAR(10) DEFAULT '' COMMENT '视频发布日期，格式YYYY-MM-DD',
    PRIMARY KEY (`id`),
...
(
    ...
    `date`             VARCHAR(10) DEFAULT '' COMMENT '笔记发布日期，格式YYYY-MM-DD',
    PRIMARY KEY (`id`),
...
-- 为小红书、抖音和B站的表添加日期字段
ALTER TABLE `xhs_note` ADD COLUMN `date` VARCHAR(10) DEFAULT '' COMMENT '笔记发布日期，格式YYYY-MM-DD';
ALTER TABLE `douyin_aweme` ADD COLUMN `date` VARCHAR(10) DEFAULT '' COMMENT '视频发布日期，格式YYYY-MM-DD';
ALTER TABLE `bilibili_video` ADD COLUMN `date` VARCHAR(10) DEFAULT '' COMMENT '视频发布日期，格式YYYY-MM-DD';
